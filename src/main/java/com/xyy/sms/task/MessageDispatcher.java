...
public class MessageDispatcher implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            String messageKey = template.boundListOps(Constant.KEY_PENDING_LIST).rightPop(0,TimeUnit.SECONDS);
            ...
            try {
                pool.execute(new HandlerWrapper(messageKey,message,messageHandler));
